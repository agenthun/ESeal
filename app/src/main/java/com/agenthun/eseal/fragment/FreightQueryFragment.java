 ...
 * @date 16/3/7 上午5:47.
 */
public class FreightQueryFragment extends Fragment {
    ...
    public static FreightQueryFragment newInstance(String type, String containerNo) {
        Bundle args = new Bundle();
        args.putString(ARG_TYPE, type);
        args.putString(ARG_CONTAINER_NO, containerNo);
        FreightQueryFragment fragment = new FreightQueryFragment();
